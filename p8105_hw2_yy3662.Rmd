...
# because p1task2 contains some data about close, which dates are not 15th. If we do left_join, we will lose many information from the second dataset at these dates.
