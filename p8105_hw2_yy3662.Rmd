...
snp which names p1task2 contains 787 observations of 2 variables related to Standard & Poor’s stock market index (S&P), often used as a representative measure of stock market as a whole:
...
In our final dataset, we have 1609 observations and 13 variables, where contains year, month, day, gov_gop, sen_gop, rep_gop, gov_dem, sen_dem, rep_dem, parties which shows two options of parties, and president shows which party is president from at that year, close, unemployment. The year range is from 1947-01 to 2015-06, and we only have close data at some specific dates which are not 15th. 
